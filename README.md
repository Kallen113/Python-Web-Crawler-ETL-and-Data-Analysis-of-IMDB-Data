...
### To-dos & additional Ideas for the Project:

Some of the earlier data analysis revealed distinct differences in the distributions of the following film reviews: a) audience reviews as measured by IMDB user ratings on one hand vs b) film critic reviews, as measured via metascores (weighted average of critic reviews). Does the distribution of the IMDB vs metascore reviews differ over time, or have any other patterns? For example, maybe they differ for some genres? Maybe they differ for larger-budget films or for certain movie studios? For instance, perhaps films from specific movie studios or specific genres tend to have audience reviews that are more similar to that of critic reviews than what was found in the overall aggregate 1930s-2017 film dataset.  
